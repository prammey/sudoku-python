#PUT "7" IN 2ND CELL, BOTTOM ROW OF THE IMPOSSIBLE SUDOKU (select in "load grid") BEFORE HITTING "SOLVE"
#THEN "RESET" AND PUT A "7" IN THE 3RD CELL, BOTTOM ROW BEFORE HITTING "SOLVE"
from tkinter import *
